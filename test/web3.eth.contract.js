...
describe('qkc3.eth.contract', function() {
    it('should create simple contract with one method from abi with explicit type name', function () {
        ...
        // when
        var qkc3 = new Qkc3();
        var myCon = qkc3.eth.contract(description).at(address);
    ...
    it('should create contract with nondefault constructor', function (done) {
        ...
        qkc3.eth.contract(description).new(2, {from: address, data: code}, function(e, myCon){
